...
def transform_weather_data(source_conn, target_conn):
    ...
    WITH daily_metrics AS (
        SELECT 
            ...
            hw.soil_moisture_0_to_1cm as surface_moisture,
            hw.soil_moisture_27_to_81cm as deep_moisture,
            hw.soil_temperature_0cm as surface_temp,
            hw.soil_temperature_54cm as deep_temp,
    ...
    SELECT 
        ...
        -- Calculate growing condition score (simplified example)
        ROUND(
            (CASE 
            ...
            END +
            CASE 
                WHEN precipitation_sum > 0 THEN 1.0
                ELSE 0.5
            END +
            CASE 
